        ...
        <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <a href="https://github.com/Ajaykumar0875">
                    ...
                    <div className="flex gap-2">
                        <Link to='/api?state=register' className="hidden md:block px-6 py-2 bg-orange-500 hover:bg-orange-700 active:scale-95 transition-all rounded-full text-white" hidden = {user}>
                            Get started
                        </Link>
                        <Link to='/api?state=login' className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900" hidden = {user}> 
                            Login
                        </Link>
                        <Link to= '/api' className = "hidden md:block px-8 py-2 bg-orange-500 hover:bg-orange-700  active:scale-95 transition-all rounded-full text-white" hidden = {!user}>
                            Dashboard
                        </Link>
                    </div>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-orange-600 hover:bg-orange-700 transition text-white rounded-md flex" >
                        X
                    </button>
                </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-orange-300 blur-[100px] opacity-30"></div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">    
                        Land your dream job with <span className=" bg-gradient-to-r from-orange-700 to-orange-600 bg-clip-text text-transparent text-nowrap">AI-powered </span> resumes.
                    </h1>
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link to="/api" className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-orange-400 flex items-center transition-colors">
                            Get started
