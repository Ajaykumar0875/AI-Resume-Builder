import { PlusIcon, Sparkle, XIcon } from 'lucide-react';
...
const SkillsForm = ({data,onChange}) => {
    ...
    const addSkill = ()=>{
        if(!newSkill.trim() || data.includes(newSkill.trim())) return;
   ...
   return (
        <div className='space-y-4'>
            ...
            <div className='flex gap-2'>
                <input type="text" placeholder='Enter a skill(e.g., JavaScript, TypeScript, Project Management)'
            ...
            {data.length > 0 ?(
                ...
                <div className='text-center py-6 text-gray-500'>
                    ...
                    <p className='text-sm'>Add your technical and soft skills to highlight your expertise.</p>
                </div>
            )}
            <div className='bg-blue-50 p-3 rounded-lg '>
                <p className='text-sm text-blue-800'> <strong>Tip:</strong> Add 8-12 relevant skills. Include both technical and soft skills (programming languages, tooks) and soft skills (leadership,communication)</p>
            </div>
        </div>
  )
}
