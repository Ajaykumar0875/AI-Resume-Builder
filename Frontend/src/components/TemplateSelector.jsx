...
const TemplateSelector = ({selectedTemplate,onChange}) => {
    ...
    const templates = [
...

        {
            id:"minimal-image",
            name:"Minimal Image",
            preview: "Minimal design used with a single image and clean typography."
        },
        ...
        
        {
            id:"latest",
            name:"Latest",
            preview: "A contemporary layout with bold headings and ample white space."
        }
    ]
  return (
    <div className = "relative">
        ...
        {isOpen && (
            <div className='absolute top-full w-xs p-3 mt-2 space-y-3 z-10 bg-white rounded-md
